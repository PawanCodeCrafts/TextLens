    ...
    return (
        <>
            <div className="container">
                ...
                ></textarea>
                <div className="mb-3">
<button disabled={text.length === 0} className="btn btn-info mb-2 mx-2" onClick={handleUpClick} >Convert to Uppercase</button>
                    <button
            ...
            <div className="container my-2">
                ...
                <p>{text.length > 0 ? handleWordFrequency() : "No words to analyze."}</p>
                <h4>Text Preview:</h4>
